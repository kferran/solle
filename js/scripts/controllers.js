...
var MembershipCtrl = function($scope, $http, countriesService, membershipService, loginService, basket,messageManager){
    $scope.customer = {};
...
var CartCtrl = function($scope, $http, basket,countriesService, orderService,  statesService, loginService, sessionManager,messageManager){
    $scope.basket = basket;
    $scope.loginService = loginService;
    $scope.items = {};
    $scope.countries = {};
...
var AppCtrl = function($scope, $http, loginService,messageManager){
    $scope.loginService = loginService;
    ...
    // $scope.$watch('loginService.getUser()', function(scope,newValue, oldValue){
